...
<html lang="en">
    <head>
        ...
        <title>Success | MS AIRLINES</title>
    ...
    <body style="background-color: black">
        ...
        <div class="container-fluid" id="content">
            <div class="col-md-12">
                <div class="jumbotron">
                      <h2 align="center"><b>Your booking is confirmed. Thank you for booking .</b></h2><hr>
                    <center><p><h2>Click <a href="booking_history.php">here</a> to view your booking history.</h2></p></center>
                </div>
            </div>
        </div>
		<br><br>
